...
export default function PhoneMockup({ url }) {
  const displayUrl = url || 'https://devlabs.automatech.live'
        ...
        <div className="bg-white rounded-[32px] overflow-hidden h-full flex flex-col">
          <div className="bg-slate-900 px-4 pt-8 pb-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <MdSignalCellularAlt className="text-white text-sm" />
              <MdWifi className="text-white text-sm" />
              <MdBattery80 className="text-white text-sm" />
            </div>
          </div>
          <div className="bg-slate-800 px-3 py-1.5 flex items-center gap-2">
            ...
            <div className="flex-1 bg-slate-700 rounded-full px-2 py-0.5">
              <p className="text-slate-300 text-xs truncate">{hostname}</p>
            </div>
          </div>
          <div className="flex-1 bg-gradient-to-br from-sky-50 to-blue-100 flex flex-col items-center justify-center p-4 gap-3">
            ...
            <div className="w-full bg-white rounded-xl p-2 shadow-sm">
              <div className="h-2 bg-slate-200 rounded-full mb-1.5 w-3/4" />
          ...
          <div className="bg-white border-t border-slate-100 px-6 py-2 flex justify-around">
            {[...Array(5)].map((_, i) => (
              <div key={i} className={`w-5 h-5 rounded-md ${i === 2 ? 'bg-primary-500' : 'bg-slate-200'}`} />
            ))}
          </div>
        </div>
